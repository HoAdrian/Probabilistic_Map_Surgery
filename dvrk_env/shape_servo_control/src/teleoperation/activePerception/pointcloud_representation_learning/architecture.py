...
#         self.bn1 = nn.GroupNorm(1, self.embedding_size)
#         self.bn2 = nn.GroupNorm(1, self.embedding_size)

#     def forward(self, x, get_global_embedding=False):
#         batch_size = x.shape[0]
#         point_dim = x.shape[1] #3
#         num_points = x.shape[2]

#         # encoder
#         l1_x, l1_points = self.sa1(x, x)
...
#         x = self.fc3(x)
#         x = x.view(batch_size, point_dim, self.num_points)
